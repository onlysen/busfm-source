...
<head>
	...
	<title>巴士电台</title>
	<link href="css/public.css?v=1.3.1" rel="stylesheet" type="text/css" />
	<!--[if IE 6]>
...
落在低处
	...
	<span class="ietxt">本站大量内容基于HTML5和CSS3，为了得到最好的浏览效果和用户体验，请尝试下载或更新至最新的浏览器及版本...</span>
	</div>
	<![endif]-->
...
<script type="text/javascript" src="js/playControl.min.js?v=2.2.7"></script>
<!--script type="text/javascript" src="js/jquery.mousewheel.min.js"></script-->
<script type="text/javascript" src="js/control.min.js?v=1.9.8"></script>
<!--[if IE 6]>
