	...
	<div id="sidebar">
		...
		<div id="user-panel">
			...
			<ul id="u-info">
				...
				<li>您于<span class="u-info-regtimes"><?PHP echo date('Y年m月d日H时i分',$_COOKIE['join_time']); ?></span>搭乘本巴士</li>
...
<script type="text/javascript" src="js/bak/jquery.jplayer.min.js"></script>
<script type="text/javascript" src="js/bak/playControl.min.js?v=2.0.1"></script>
<!--script type="text/javascript" src="js/jquery.mousewheel.min.js"></script-->
<script type="text/javascript" src="js/control.min.js?v=1.8.6"></script>
<!--[if IE 6]>
